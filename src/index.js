...
function renderStudyGuide() {
  const guides = [
    ...
    {cat:"진로",title:"고교학점제 시대, 과목 선택 가이드",desc:"전면 시행 고교학점제에 맞는 과목 선택 전략입니다.",tag:"최신"},
    ...
    {cat:"학습법",title:"집중력 높이는 공부 환경 만들기",desc:"공부할 때 집중력을 최대로 끌어올리는 환경 세팅 비법.",tag:"인기"},
    {cat:"시험대비",title:"수능 D-100 완벽 학습 플래너",desc:"수능 100일 전부터 시작하는 과목별 전략적 학습 계획표.",tag:"추천"},
    {cat:"학부모",title:"과외 선생님 선택할 때 꼭 확인할 것",desc:"좋은 과외 선생님을 찾기 위한 체크리스트와 질문 리스트.",tag:""},
    {cat:"과목별",title:"국어 비문학 독해 핵심 전략",desc:"수능 국어 비문학 지문을 빠르게 정확하게 읽는 방법.",tag:"인기"},
    {cat:"과목별",title:"과학 실험 보고서 잘 쓰는 법",desc:"과학 서술형 문제와 실험 보고서 작성의 핵심 요령.",tag:""},
    {cat:"입시정보",title:"수시 vs 정시, 나에게 유리한 전형은?",desc:"자신의 강점에 맞는 입시 전형 선택 방법을 분석합니다.",tag:"최신"},
    {cat:"학습법",title:"시간 관리의 기술: 플래너 활용법",desc:"하루 24시간을 효율적으로 쓰는 학생들의 시간 관리 비법.",tag:""},
    {cat:"학부모",title:"사춘기 자녀와 공부 갈등 해결법",desc:"사춘기 자녀의 학습 의욕을 되살리는 소통법과 해결 전략.",tag:"추천"},
    {cat:"진로",title:"문과 이과 선택, 후회 없는 결정법",desc:"적성과 진로에 맞는 문이과 선택 기준과 체크리스트.",tag:""},
  ];
  const tagMap = {'인기':'sg-tag-hot','추천':'sg-tag-rec','최신':'sg-tag-new'};
  return `<!DOCTYPE html><html lang="ko"><head>
  ${commonHead('학습 가이드 - 과외안하니', '학습법, 시험 대비, 입시 정보 등 학생과 학부모를 위한 교육 정보를 제공합니다.', 'https://anhani.com/학습가이드')}
  <style>${commonStyles()}
  ...
  <div class="sg-wrap">
    ...
    <div class="sg-grid">
      ${guides.map((g,i) => `<a href="/학습가이드/${i}" class="sg-card">
...
const GUIDE_ARTICLES = [
  {secs:[{h:"자기주도 학습이란?",p:"자기주도 학습은 스스로 목표를 세우고, 계획하고, 실행하는 학습 방식이에요. 이 능력이 있는 학생은 과외나 학원 없이도 꾸준히 성적을 유지할 수 있습니다."},{h:"핵심 전략 5가지",p:"1. 매일 같은 시간에 공부 시작하기 2. 오늘 배운 것 10분 복습하기 3. 주간 목표를 구체적으로 세우기 4. 오답노트로 실수 관리하기 5. 주 1회 자기 점검 시간 갖기. 이 5가지만 실천해도 성적이 눈에 띄게 달라집니다."},{h:"실천 로드맵",p:"1주차는 습관 만들기, 2~4주차는 루틴 정착, 2개월차부터 자기만의 학습 시스템이 완성됩니다. 과외 선생님과 함께 시작하면 방향 설정이 훨씬 빨라요."}]},
  {secs:[{h:"시험 2주 전, 뭐부터 해야 할까?",p:"가장 먼저 시험 범위를 정확히 확인하세요. 교과서 목차를 기준으로 어떤 단원이 나오는지 정리하고, 과목별 공부 시간을 배분하는 것이 첫 번째 단계입니다."},{h:"과목별 전략",p:"국어: 교과서 작품 재독 + 서술형 연습. 수학: 기출 유형 분석 + 오답 재풀이. 영어: 교과서 본문 암기 + 문법 정리. 사회/과학: 개념 마인드맵 + 빈출 키워드 암기. 이렇게 과목 특성에 맞게 접근하세요."},{h:"D-7 최종 점검법",p:"마지막 1주일은 새로운 내용보다 복습에 집중하세요. 오답노트 재풀이, 핵심 개념 빠르게 훑기, 실전 시간 배분 연습이 핵심입니다."}]},
  {secs:[{h:"2027 대입 전형 주요 변경점",p:"교육부 발표에 따르면 수시 학생부교과전형 비중이 확대되고, 정시 수능 위주 전형도 일부 조정됩니다. 자세한 변경 사항은 각 대학 입시요강을 반드시 확인하세요."},{h:"수시 대비 전략",p:"학생부교과: 내신 관리가 최우선. 학생부종합: 세특, 동아리, 봉사활동의 일관된 스토리가 중요합니다. 논술: 대학별 기출 분석이 핵심이에요."},{h:"정시 대비 전략",p:"수능 과목별 배점 비중을 파악하고, 유리한 대학을 미리 선정하세요. 모의고사 성적 추이를 분석해서 목표 대학을 현실적으로 설정하는 것이 중요합니다."}]},
  {secs:[{h:"아이에게 동기를 주는 대화법",p:"'공부해!'가 아니라 '오늘 뭐 배웠어?'로 시작하세요. 결과가 아닌 과정을 칭찬하면 아이의 내적 동기가 살아납니다. '어제보다 10분 더 했네!'처럼 구체적으로 인정해주세요."},{h:"역효과 나는 말 vs 효과적인 말",p:"❌ '친구는 하는데 왜 너만 못하니' → ✅ '네가 노력한 거 알아, 같이 방법을 찾아보자'. ❌ '과외비가 얼만데' → ✅ '투자하는 만큼 네 실력이 될 거야'. 비교와 압박 대신 지지와 격려가 효과적입니다."},{h:"장기적 동기부여 전략",p:"아이 스스로 목표를 정하게 하고, 달성했을 때 적절한 보상을 약속하세요. 진로 탐색을 함께 하면서 공부의 이유를 아이 스스로 발견하게 돕는 것이 가장 강력한 동기부여입니다."}]},
  {secs:[{h:"수학 등급별 현재 위치 진단",p:"1~2등급: 킬러문항 대비 필요, 3~4등급: 개념 빈틈 보완이 핵심, 5등급 이하: 기초부터 다시 잡아야 합니다. 현재 등급에 따라 전략이 완전히 다르니 정확한 진단이 우선입니다."},{h:"등급별 맞춤 로드맵",p:"5등급→3등급: 교과서 개념 + 기본 유형 반복 (2~3개월). 3등급→2등급: 유형별 문제 + 오답 관리 (2~3개월). 2등급→1등급: 심화 + 킬러문항 훈련 (3~6개월). 과외와 병행하면 기간을 절반으로 단축할 수 있어요."},{h:"추천 교재",p:"기초: 개념원리, 쎈 기본. 중급: 쎈, 마플 시너지. 심화: 블랙라벨, 마플 교과서. 수능: 수학의 바이블, EBS 연계교재. 등급에 맞지 않는 교재를 풀면 시간만 낭비됩니다."}]},
  {secs:[{h:"독해 속도가 느린 진짜 이유",p:"단어를 몰라서가 아니라, 문장 구조를 파악하지 못하기 때문입니다. 주어-동사-목적어를 빠르게 찾는 연습, 수식어 덩어리를 묶어 읽는 연습이 독해 속도를 2배로 올려줍니다."},{h:"단계별 훈련법",p:"1단계: 문장 끊어 읽기 (주어/동사 표시). 2단계: 단락 요약 연습 (1문장으로). 3단계: 시간 제한 독해 (지문당 3분). 4단계: 실전 모의고사 풀이. 매일 1지문씩 꾸준히 하면 한 달 만에 체감할 수 있어요."},{h:"자주 나오는 독해 유형 공략",p:"주제 찾기: 첫문장과 끝문장에 집중. 빈칸: 앞뒤 논리 관계(역접/인과) 파악. 순서: 지시어·연결어 추적. 유형별 풀이법을 익히면 정확도가 크게 올라갑니다."}]},
  {secs:[{h:"고교학점제란?",p:"학생이 직접 수강 과목을 선택하고, 이수 기준을 충족하면 졸업하는 제도입니다. 진로에 따라 과목을 자유롭게 선택할 수 있어서, 미리 진로를 탐색하는 것이 매우 중요해졌어요."},{h:"과목 선택 전략",p:"이공계: 미적분+확통+물리/화학 필수. 인문계: 독서+언매+사회탐구 조합. 의대: 생명과학+화학+수학 심화. 대학별 반영 과목을 확인하고 선택하세요."},{h:"주의할 점",p:"성적이 잘 나올 과목만 고르면 안 돼요. 대학에서 이수 권장 과목을 지정하는 경우가 많으니, 목표 대학의 요구사항을 반드시 먼저 확인하세요."}]},
  {secs:[{h:"오답노트, 왜 필요한가?",p:"같은 유형의 문제를 반복해서 틀리는 건 개념이 아닌 '습관'의 문제입니다. 오답노트는 이 습관을 고치는 가장 확실한 도구예요."},{h:"효과적인 오답노트 작성법",p:"① 틀린 문제 붙이기 ② 틀린 이유 3가지 중 분류 (개념 부족/계산 실수/문제 오독) ③ 올바른 풀이 직접 써보기 ④ 1주 후 재풀이. 이 4단계를 지키면 같은 실수를 95% 줄일 수 있습니다."},{h:"오답노트 활용 팁",p:"시험 1주 전에 오답노트만 한번 훑어보세요. 자신의 약점 유형만 집중 복습할 수 있어서, 벼락치기보다 훨씬 효율적입니다. 과외 선생님과 함께 오답 분석을 하면 효과가 배가됩니다."}]},
  {secs:[{h:"학생부 종합전형이란?",p:"내신 성적뿐 아니라 학교생활 전반(세특, 동아리, 봉사, 독서 등)을 종합 평가하는 전형입니다. 한마디로 '어떤 학생인가'를 보는 입시예요."},{h:"합격하는 학생의 공통점",p:"① 진로 관련 활동의 일관성 ② 세부능력특기사항(세특)의 깊이 ③ 자기주도적 탐구 경험 ④ 독서와 탐구의 연결. 단순히 많은 활동보다 '왜 했는지'가 중요합니다."},{h:"준비 시작 시기",p:"고1부터 시작하는 것이 이상적이지만, 고2에서 시작해도 늦지 않아요. 핵심은 진로 방향을 정하고, 그에 맞는 활동을 '선택과 집중'하는 것입니다."}]},
  {secs:[{h:"집중력 높이는 환경 세팅",p:"공부 공간에서 스마트폰을 반드시 분리하세요. 눈에 보이기만 해도 집중력이 20% 떨어진다는 연구 결과가 있어요. 책상 위에는 현재 공부할 과목 교재만 두세요."},{h:"시간대별 최적 학습법",p:"오전: 수학, 과학 등 사고력 필요한 과목. 오후: 영어, 국어 등 언어 과목. 저녁: 암기 과목 복습. 뇌의 리듬에 맞추면 같은 시간에 더 많이 학습할 수 있어요."},{h:"25분 집중법 (포모도로)",p:"25분 집중 → 5분 휴식을 반복하는 방법입니다. 4세트 후 15분 긴 휴식. 이 방법만으로도 하루 공부 효율이 30% 이상 올라갑니다."}]},
  {secs:[{h:"수능 D-100, 지금 뭘 해야 하나?",p:"남은 100일을 3단계로 나누세요. D-100~D-60: 취약 과목 집중 보완. D-60~D-30: 실전 모의고사 루틴 정착. D-30~D-day: 기출 재풀이 + 컨디션 관리."},{h:"과목별 100일 전략",p:"국어: EBS 연계 지문 정리. 수학: 4점 문항 유형 집중. 영어: 듣기 만점 + 독해 시간 단축. 탐구: 개념 회독 + 기출 분석. 제2외국어: 기출만 3회독."},{h:"멘탈 관리법",p:"100일은 충분한 시간이에요. 매일 조금씩 성장하는 것에 집중하세요. 모의고사 성적에 일희일비하지 말고, 오답 분석에 시간을 투자하세요. 과외 선생님이 페이스 조절을 도와줄 수 있어요."}]},
  {secs:[{h:"좋은 과외 선생님의 조건",p:"① 해당 과목 지도 경력 2년 이상 ② 학생 수준에 맞는 설명 능력 ③ 수업 후 피드백과 학습 보고서 제공 ④ 인근 학교 내신 경향 파악. 이 4가지를 갖춘 선생님이라면 믿고 맡겨도 됩니다."},{h:"반드시 물어볼 질문 리스트",p:"체험 수업 가능한가요? 숙제와 복습 관리는 어떻게 하시나요? 시험 기간에 추가 수업이 가능한가요? 성적 향상 사례가 있나요? 이 4가지 질문만으로도 선생님의 수준을 파악할 수 있어요."},{h:"과외 시작 후 체크포인트",p:"1개월 차: 아이와 선생님 궁합 확인. 2개월 차: 학습 태도 변화 관찰. 3개월 차: 성적 변화 확인. 3개월 안에 변화가 없다면 수업 방식을 조정하거나 선생님 교체를 고려하세요."}]},
  {secs:[{h:"비문학 독해, 왜 어려운가?",p:"비문학은 배경지식이 없는 주제를 짧은 시간에 이해해야 하기 때문에 어려워요. 하지만 지문의 구조를 파악하는 훈련을 하면 어떤 주제든 빠르게 핵심을 잡을 수 있습니다."},{h:"비문학 독해 3단계 전략",p:"1단계: 문단별 핵심 문장 찾기 (주로 첫 문장). 2단계: 문단 간 관계 파악 (나열/대조/인과). 3단계: 전체 주제 한 문장으로 요약. 이 과정을 매일 1지문씩 연습하면 3주면 체감됩니다."},{h:"자주 나오는 비문학 영역",p:"인문(철학·심리), 사회(경제·법), 과학(물리·생물), 기술(IT·공학), 예술(미학·음악). 각 영역의 핵심 용어를 미리 익혀두면 낯선 지문도 쉽게 읽을 수 있어요."}]},
  {secs:[{h:"과학 서술형의 핵심",p:"과학 서술형은 '현상 설명 + 원리 적용 + 결론 도출' 3단계로 답안을 구성하세요. 단순 암기가 아니라 원리를 이해하고 자기 언어로 설명할 수 있어야 합니다."},{h:"실험 보고서 잘 쓰는 법",p:"① 목적: 무엇을 확인하려는 실험인지 ② 가설: 예상 결과와 이유 ③ 과정: 변인 통제 방법 명시 ④ 결과: 데이터 표/그래프 ⑤ 결론: 가설과 비교 분석. 이 5단계를 지키면 만점 보고서가 됩니다."},{h:"서술형 오답 줄이는 팁",p:"핵심 용어를 정확히 사용하세요. '열이 이동한다'가 아니라 '열에너지가 고온에서 저온으로 전도된다'처럼 과학적 용어로 서술해야 감점을 피할 수 있어요."}]},
  {secs:[{h:"수시와 정시, 어떻게 다른가?",p:"수시: 내신+학생부+면접/논술. 정시: 수능 성적 위주. 수시는 고1부터 꾸준한 관리가 필요하고, 정시는 수능 집중력이 핵심입니다."},{h:"나에게 유리한 전형 판단법",p:"내신 1~2등급 + 활동 풍부 → 학생부종합. 내신 1~3등급 + 안정적 → 학생부교과. 내신 불리 + 수능 강점 → 정시. 글쓰기 실력 → 논술. 자신의 강점을 냉정하게 분석하는 것이 첫 걸음입니다."},{h:"혼합 전략도 가능",p:"수시 6장 + 정시 3장, 총 9번의 기회가 있어요. 수시에 올인하지 말고 정시도 병행 준비하는 것이 안전합니다. 과외 선생님과 함께 입시 전략을 짜보세요."}]},
  {secs:[{h:"플래너 활용의 핵심",p:"플래너는 '할 일 목록'이 아니라 '시간 블록 배정표'예요. 과목별로 몇 시간을 투자할지 미리 정하고, 빈 시간에 끼워 넣는 것이 효과적입니다."},{h:"시간 관리 4원칙",p:"① 중요하고 급한 일 먼저 (시험 대비) ② 중요하지만 급하지 않은 일 매일 조금씩 (복습) ③ 급하지만 중요하지 않은 일 위임 ④ 둘 다 아닌 일 제거 (SNS). 이 원칙만 지켜도 하루 2시간을 더 확보할 수 있어요."},{h:"현실적인 일일 스케줄",p:"학교: 7시~16시. 자습/과외: 17시~19시. 복습: 20시~22시. 이렇게 하루 4시간만 확보해도 충분합니다. 핵심은 매일 같은 루틴을 유지하는 것이에요."}]},
  {secs:[{h:"사춘기 자녀, 왜 공부를 거부할까?",p:"사춘기는 자아 정체성을 형성하는 시기예요. 부모의 강요에 반항하는 것이 정상적인 발달 과정입니다. '시키면 안 한다'는 것을 이해하고 접근 방식을 바꿔야 해요."},{h:"효과적인 소통법",p:"명령 대신 질문하세요. '공부해'가 아니라 '오늘 계획은 뭐야?'. 결과 대신 노력을 인정하세요. '몇 점 받았어?'가 아니라 '열심히 했구나'. 작은 변화가 큰 차이를 만듭니다."},{h:"과외가 돌파구가 될 수 있어요",p:"부모와의 갈등이 심할 때, 제3자인 과외 선생님이 중재자 역할을 할 수 있어요. 좋은 선생님은 공부뿐 아니라 아이의 고민도 들어주면서 신뢰 관계를 만들어 줍니다."}]},
  {secs:[{h:"문과와 이과, 무엇이 다른가?",p:"문과: 언어·사회·인문학 중심, 법학·경영·교육·언론 등으로 진학. 이과: 수학·과학 중심, 공학·의학·자연과학 등으로 진학. 하지만 최근 융합 전공이 늘면서 경계가 허물어지고 있어요."},{h:"선택 기준 체크리스트",p:"① 수학을 즐기는가? (이과 유리) ② 글 읽고 쓰는 걸 좋아하는가? (문과 유리) ③ 목표 직업이 있다면 어느 쪽? ④ 내신에서 어느 과목이 강한가? 4가지를 종합적으로 고려하세요."},{h:"후회 없는 결정을 위해",p:"고1 때 결정이 어렵다면, 양쪽 과목을 모두 열심히 해보세요. 고1 2학기까지 경험해보고 결정해도 늦지 않습니다. 진로 상담 선생님이나 과외 선생님과 함께 방향을 잡아보세요."}]},
];

function renderStudyGuideArticle(idx) {
  if (idx < 0 || idx >= GUIDE_ARTICLES.length) return null;
  const guides = [{cat:"학습법",title:"효과적인 자기주도 학습법 5가지"},{cat:"시험대비",title:"내신 시험 2주 전 완벽 대비 전략"},{cat:"입시정보",title:"2027 대입 전형 변경 사항 총정리"},{cat:"학부모",title:"자녀 학습 동기부여하는 대화법"},{cat:"과목별",title:"수학 등급 올리는 단계별 로드맵"},{cat:"과목별",title:"영어 독해 속도 2배 올리는 방법"},{cat:"진로",title:"고교학점제 시대, 과목 선택 가이드"},{cat:"학습법",title:"오답노트 제대로 만드는 법"},{cat:"입시정보",title:"학생부 종합전형 합격 비결"},{cat:"학습법",title:"집중력 높이는 공부 환경 만들기"},{cat:"시험대비",title:"수능 D-100 완벽 학습 플래너"},{cat:"학부모",title:"과외 선생님 선택할 때 꼭 확인할 것"},{cat:"과목별",title:"국어 비문학 독해 핵심 전략"},{cat:"과목별",title:"과학 실험 보고서 잘 쓰는 법"},{cat:"입시정보",title:"수시 vs 정시, 나에게 유리한 전형은?"},{cat:"학습법",title:"시간 관리의 기술: 플래너 활용법"},{cat:"학부모",title:"사춘기 자녀와 공부 갈등 해결법"},{cat:"진로",title:"문과 이과 선택, 후회 없는 결정법"}];
  const g = guides[idx];
  ...
  return `<!DOCTYPE html><html lang="ko"><head>
  ${commonHead(g.title + ' | 과외안하니', g.title + ' - 학생과 학부모를 위한 학습 가이드.', canonical)}
  <meta property="og:image" content="${thumbUri}">
  <style>${commonStyles()}
    .ga-hero{background:linear-gradient(135deg,#052e16,#16a34a);color:#fff;padding:48px 24px 40px;text-align:center}
    .ga-hero-badge{display:inline-block;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.2);padding:5px 14px;border-radius:20px;font-size:12px;font-weight:600;margin-bottom:16px}
    .ga-hero h1{font-size:26px;font-weight:900;line-height:1.4;margin-bottom:8px}
    .ga-hero-meta{font-size:13px;color:rgba(255,255,255,.6)}
    .ga-wrap{max-width:720px;margin:0 auto;padding:32px 20px 0}
    .ga-thumb{width:100%;border-radius:12px;margin-bottom:24px}
    .ga-sections{display:flex;flex-direction:column;gap:16px;margin-bottom:32px}
    .ga-sec{background:#fff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;transition:all .2s}
    .ga-sec:hover{border-color:#86efac;box-shadow:0 4px 16px rgba(22,163,74,.06)}
.ga-sec-head{display:flex;align-items:center;gap:14px;padding:18px 20px;background:#f0fdf4;border-bottom:1px solid #bbf7d0}
    .ga-sec-num{width:32px;height:32px;background:#16a34a;color:#fff;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:800;flex-shrink:0}
    .ga-sec-title{font-size:17px;font-weight:700;color:#0f172a}
    .ga-sec-body{padding:18px 20px}
.ga-sec-body p{font-size:15px;color:#475569;line-height:1.8;margin:0;word-break:keep-all}
    .ga-cta{background:linear-gradient(135deg,#052e16,#16a34a);border-radius:16px;padding:32px 24px;text-align:center;color:#fff;margin:32px 0}
    .ga-cta h3{font-size:20px;font-weight:800;margin-bottom:6px}.ga-cta p{font-size:13px;opacity:.7;margin-bottom:16px}
    ...
    .ga-related{margin-top:36px;padding-top:28px;border-top:2px solid #f1f5f9}
    .ga-related h3{font-size:18px;font-weight:800;color:#0f172a;margin-bottom:16px;padding-left:12px;border-left:4px solid #16a34a}
    .ga-related-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}
    .ga-related-item{padding:14px 16px;background:#fff;border:1px solid #e2e8f0;border-radius:10px;text-decoration:none;color:#334155;font-size:14px;font-weight:500;transition:all .2s;display:flex;justify-content:space-between;align-items:center}
    .ga-related-item:hover{border-color:#16a34a;color:#16a34a;transform:translateX(4px)}
    @media(max-width:640px){.ga-hero h1{font-size:22px}.ga-related-grid{grid-template-columns:1fr}}
  </style></head><body>
  ${navHTML('guide')}
  <div class="ga-hero">
    <div class="ga-hero-badge">📚 ${g.cat}</div>
    <h1>${g.title}</h1>
    <div class="ga-hero-meta">과외안하니 교육팀 · 2026년 4월</div>
  </div>
  <div class="ga-wrap">
    <img src="${thumbUri}" alt="${g.title}" class="ga-thumb" width="1200" height="630">
    <div class="ga-sections">
      ${a.secs.map((s,i) => `<div class="ga-sec"><div class="ga-sec-head"><div class="ga-sec-num">${i+1}</div><div class="ga-sec-title">${s.h}</div></div><div class="ga-sec-body"><p>${s.p}</p></div></div>`).join('')}
    </div>
    <div class="ga-cta">
      <h3>맞춤 과외 무료 상담</h3>
    ...
    <div class="ga-related">
      ...
      <div class="ga-related-grid">
        ${guides.filter((_,i)=>i!==idx).slice(0,8).map((gg,i)=>{const ri=i>=idx?i+1:i;return `<a href="/학습가이드/${ri}" class="ga-related-item"><span>${gg.title}</span><span>→</span></a>`;}).join('')}
      </div>
    </div>
  </div>
  ${footerHTML()}
...
export default {
  async fetch(request) {
    ...
    // 버전 확인
    if (pathname === '/version') {
      return new Response('v9-508KB-guide18', { headers: { 'Content-Type': 'text/plain' } });
    }
