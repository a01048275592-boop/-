...
const SUBJECTS = ["국어", "영어", "수학", "사회", "과학", "코딩", "검정고시", "외국어"];
...
const SUBJECT_CONTENT = {
  ...
  "외국어": {
    why: [
      "외국어 실력은 글로벌 시대에 꼭 필요한 핵심 역량이에요. 영어뿐만 아니라 중국어, 일본어 등 다양한 외국어 학습이 중요합니다.",
      "외국어 회화는 혼자 공부하기 어렵고, 원어민 수준의 발음과 표현을 익히려면 전문 선생님의 지도가 반드시 필요해요.",
      "외국어 학습은 어릴수록 효과적이에요. 언어 감각이 뛰어난 시기에 시작하면 원어민에 가까운 발음과 자연스러운 표현을 익힐 수 있습니다.",
    ],
    tip: [
      "외국어 과외 선생님은 해당 언어권에서 생활한 경험이 있는 분이 좋아요. 교과서에 없는 실전 표현을 가르쳐줄 수 있습니다.",
      "좋은 외국어 선생님은 학생의 레벨에 맞춰 수업 난이도를 조절해요. 왕초보부터 고급까지 체계적인 커리큘럼이 있는지 확인하세요.",
      "외국어 과외에서는 스피킹 위주의 수업이 효과적이에요. 문법만 가르치는 선생님보다 실제 대화 연습을 많이 시켜주는 분을 선택하세요.",
    ],
    method: [
      "외국어 학습에서 가장 효과적인 방법은 매일 꾸준히 듣고 말하는 거예요. 하루 30분씩 원어민 발음을 듣고 따라하면 3개월 후 확실한 변화를 느낄 수 있어요.",
      "외국어는 실생활에서 사용해봐야 실력이 늘어요. 과외 수업에서 배운 표현을 일상에서 써보는 습관이 중요합니다.",
    ]
  }
};
