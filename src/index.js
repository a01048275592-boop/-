...
function commonStyles() {
  return `@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;500;600;700;800;900&display=swap');*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Noto Sans KR',-apple-system,sans-serif;background:#f8fafc;color:#334155;line-height:1.7}.nav{background:#fff;border-bottom:1px solid #e2e8f0;position:sticky;top:0;z-index:100}${navStyles()}`;
}
...
function renderHomepage() {
  ...
  const subjectCards=SUBJECTS.map(s=>`<a href="/과목별/${encodeURIComponent(s)}" class="subject-card" style="--accent:${subjectColors[s]}"><span class="subject-icon">${subjectIcons[s]}</span><h3>${s}</h3><p>${s} 과외<br class="mo-br">정보 보기</p></a>`).join("");
  const paSlides=[1,2,3,4,5,6,7,8,9].map(i=>`<div class="sys-slide"><img src="${A}수행평가${i}.png" alt="수행평가 관리 사례 ${i}"></div>`).join("")+`<div class="sys-slide"><img src="${A}수행평가1.png" alt=""></div>`;
