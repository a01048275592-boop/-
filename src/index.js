...
const FOOTER_LOGO_URI = "data:image/jpeg;base64,";
...
// --- 홈페이지 ---
function inquiryBlock(){return `  <!-- 체험 수업 신청 섹션 -->
...
function renderDongCategoryPage(sido, sigungu, dong, type, arg1, arg2) {
  const all = [...(DONG_DATA[sigungu]||[]), ...(EUP_MYEON[sigungu]||[])];
...
function renderElemSchool(sd,sg,sn){
  ...
  // 5개 섹션 풀에서 학교마다 4~5개 다른 순서로 선택 → 모사율 낮춤
  const SP_DEFS=[
    {t:`${sn} 맞춤 학습 전략`,c:SCHOOL_BODY_POOL[(h*2)%SCHOOL_BODY_POOL.length](sn,lv)},
    {t:`${sn} 과외 안내`,c:SCHOOL_GUIDE_POOL[(h*3)%SCHOOL_GUIDE_POOL.length](sn,lv,rg)},
    {t:`${sn} 과외 특징`,c:SCHOOL_FEATURE_POOL[(h*5)%SCHOOL_FEATURE_POOL.length](sn,lv,rg)},
    {t:`${sn} 과외 커리큘럼`,c:SCHOOL_CURRICULUM_POOL[(h*7)%SCHOOL_CURRICULUM_POOL.length](sn,lv,rg)},
    {t:`${sn} 추가 학습 가이드`,c:SCHOOL_BODY_POOL[(h*11+3)%SCHOOL_BODY_POOL.length](sn,lv)}
  ];
  const sCnt=4+(h%2);// 4 또는 5 섹션
  const sOrd=[(h)%5,(h+1)%5,(h+2)%5,(h+3)%5,(h+4)%5].slice(0,sCnt);
  const secHTML=sOrd.map(i=>`<div class="dsc"><h3 class="dh3">${SP_DEFS[i].t}</h3><p>${SP_DEFS[i].c}</p></div>`).join('');
  // 핵심 팁 1~2개
  const tCnt=1+(h%2);
  const tipHTML=Array.from({length:tCnt},(_,j)=>`<div class="dtp">💡 ${SCHOOL_TIPS_POOL[(h+j*3)%SCHOOL_TIPS_POOL.length](sn)}</div>`).join('');
  // FAQ 2~3개, 시작 인덱스도 학교마다 다름
  const fqCnt=2+(h%2),fqStart=h%4;
  const fqs=Array.from({length:fqCnt},(_,j)=>SCHOOL_FAQ_POOL[(fqStart+j)%4](sn,lv));
  ...
  return `<!DOCTYPE html><html lang="ko"><head>${commonHead(`${sn} 과외 추천 - ${rg} 맞춤 1:1 과외 | 과외안하니`,`${sn}(${rg}) 재학생을 위한 학교 맞춤 1:1 과외. 학교별 학습 환경, 단원 평가 대비, 과외 선생님 매칭 정보를 확인하세요.`,`https://anhani.com${SP}`)}<style>${commonStyles()}${eCSS()}</style></head><body>${navHTML('region')}<div class="db"><a href="/">홈</a> > <a href="/학교급별">학교별</a> > <a href="/학교급별/elem">초등학교</a> > <a href="/학교급별/elem/${eu(sd)}">${sd}</a> > <a href="/학교급별/elem/${eu(sd)}/${eu(sg)}">${sg}</a> > ${sn}</div><div class="dh">${eThumb(sn,h)}</div><div class="dw"><div class="dt"><h1>${sn} <em>과외</em></h1><div class="dm"><span class="dmi">${rg}</span><span class="dmi">공립</span><span class="dmi">일반</span></div></div><div class="dc"><p>${intro}</p>${secHTML}<div class="dsc"><h3 class="dh3">${sn} 핵심 학습 팁</h3>${tipHTML}</div><div class="dsc"><h3 class="dh3">자주 묻는 질문</h3>${fqs.map(f=>`<div class="dfq"><div class="dfq-q">Q. ${f.q}</div><div class="dfq-a">A. ${f.a}</div></div>`).join('')}</div><div class="dsc"><h3 class="dh3">${sn} 관련 가이드</h3><div class="dar">${arts}</div></div>${nbHTML}<div class="dcta"><h4>${sn} 맞춤 과외, 무료 상담받으세요</h4><p>학교별 학습 환경을 아는 선생님과 1:1 매칭</p><div class="dctb"><a href="/체험신청" class="dctn">⭐ 무료 체험</a><a href="http://pf.kakao.com/_SbyVX/chat" target="_blank" class="dctn">💬 카톡 상담</a></div></div></div></div>${footerHTML()}</body></html>`;
}
